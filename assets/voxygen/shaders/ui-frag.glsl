...
layout (set = 1, binding = 1) uniform texture2D t_tex;
layout (set = 1, binding = 2) uniform sampler s_tex;
...
void main() {
    ...
    // HACK: bit 0 is set for both ordinary and north-facing images.
        ...
        tgt_color = vec4(1.0,1.0,1.0,1.0) /* f_color * texture(sampler2D(t_tex, s_tex),f_uv) */;
    // 2D Geometry
