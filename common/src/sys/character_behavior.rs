...
pub trait CharacterBehavior {
    ...
    fn glide_wall(&self, data: &JoinData) -> StateUpdate { StateUpdate::from(data) }
    ...
    fn handle_event(&self, data: &JoinData, event: ControlAction) -> StateUpdate {
        match event {
            ...
            ControlAction::GlideWall => self.glide_wall(data),
            ...
            .join()
        {
            ...
            for action in actions {
                ...
                let mut state_update = match j.character {
                    ...
                    CharacterState::GlideEquipping(data) => data.handle_event(&j, action),
            ...
            let mut state_update = match j.character {
                ...
                CharacterState::GlideEquipping(data) => data.behavior(&j),
