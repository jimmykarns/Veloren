...
impl MainMenuUi {
    ...
    fn update_layout(&mut self, global_state: &mut GlobalState, dt: Duration) -> Vec<Event> {
        ...
        //         )
        //         .font_id(self.fonts.cyri.conrod_id);
        //     let (frame_w, frame_h) = if let PopupType::AuthTrustPrompt(_) =
        // popup_type {         (65.0 * 8.0, 370.0)
        //     } else {
        //         (65.0 * 6.0, 140.0)
        //     };
        //     let error_bg = Rectangle::fill_with([frame_w, frame_h],
        // color::TRANSPARENT)         .rgba(0.1, 0.1, 0.1, if self.connect {
        // 0.0 } else { 1.0 })         .parent(ui_widgets.window);
        ...
        // self.voxygen_i18n.get("common.cancel"),
        ...
        //                 events.push(Event::AuthServerTrust(auth_server.clone(),
        // false));             },
        //         };
        ...
        //         // Input fields
        //         // Used when the login button is pressed, or enter is pressed within
        // input field         macro_rules! login {
        //             () => {
        //                 self.connect = true;
        //                 self.connecting = Some(std::time::Instant::now());
        //                 self.popup = Some(PopupData {
        //                     msg: [self.voxygen_i18n.get("main.connecting"),
        // "..."].concat(),                     popup_type:
        // PopupType::ConnectionInfo,                 });
        ...
        //                 self.connecting = Some(std::time::Instant::now());
        //                 self.popup = Some(PopupData {
        //                     msg: [self.voxygen_i18n.get("main.creating_world"),
        // "..."].concat(),                     popup_type:
        // PopupType::ConnectionInfo,                 });
        //             };
        //         }
        ...
        //                     // Note: TextBox limits the input string length to what
        // fits in it                     self.username = username.to_string();
        //                 },
        //                 TextBoxEvent::Enter => {
        //                     login!();
        //                 },
        ...
        //                     // Note: TextBox limits the input string length to what
        // fits in it                     self.password = password;
        //                 },
        //                 TextBoxEvent::Enter => {
        //                     login!();
        //                 },
        ...
        //             let (mut items, _scrollbar) =
        // List::flow_down(net_settings.servers.len())
        ...
        //                             .w_h(100.0, 50.0)
        //                             .mid_top_with_margin_on(self.ids.servers_frame,
        // 10.0)
        // //.hover_image(self.imgs.button_hover)
        // //.press_image(self.imgs.button_press)
        // .label_y(Relative::Scalar(2.0))
        ...
        // .label_font_id(self.fonts.cyri.conrod_id)
        // .label_color(TEXT_COLOR),                         ui_widgets,
        //                     )
        //                     .was_clicked()
        //                 {
        //                     self.server_address =
        // net_settings.servers[item.i].clone();
