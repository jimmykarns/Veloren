...
impl Animation for GlideWallAnimation {
    ...
    fn update_skeleton(
        ...
        *rate = 1.0;
        ...
        let shorte = (((5.0)
            / (4.0
                + 1.0 * ((anim_time as f32 * lab as f32 * 10.0 * walk).sin()).powf(2.0 as f32)))
        .sqrt())
            * ((anim_time as f32 * lab as f32 * 16.0 * walk).sin());
        ...
        next.r_hand.scale = Vec3::one();
            ...
            next.head.ori = Quaternion::rotation_z( head_look.x * 0.2 - short * 0.06)
            ...
            next.chest.ori = Quaternion::rotation_z(-0.2+short * 0.03)
            ...
            next.belt.ori = Quaternion::rotation_z(short * 0.02)
            ...
            next.shorts.ori = Quaternion::rotation_z(short * 0.05)
            ...
            next.r_foot.offset = Vec3::new(
                ...
                2.0 + skeleton_attr.foot.2 + ((footvertr * -2.5).max(-1.0)) * walkintensity,
            );
            ...
            next.torso.ori = Quaternion::rotation_y(-0.6);
