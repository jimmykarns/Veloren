...
impl Animation for RunAnimation {
    ...
    fn update_skeleton_inner(
        ...
        let short1 = (anim_time as f32 * lab as f32 * 10.0).sin();
        let short2 = (anim_time as f32 * lab as f32 * 10.0 + PI * 0.2).sin();
        let short3 = (anim_time as f32 * lab as f32 * 10.0 + PI * 0.4).sin();
        let short4 = (anim_time as f32 * lab as f32 * 10.0 + PI * 0.6).sin();
        let short5 = (anim_time as f32 * lab as f32 * 10.0 + PI * 0.8).sin();
        ...
        next.body_1.scale = Vec3::one() / 8.0 + short1 / 10.0;
        ...
        next.body_2.scale = Vec3::one() + short2 / 8.0;
        ...
        next.body_3.scale = Vec3::one() + short3 / 6.0;
        ...
        next.body_4.scale = Vec3::one() + short4 / 4.0;
        ...
        next.body_5.scale = Vec3::one() + short5 / 2.0;
