...
impl Animation for IdleAnimation {
    ...
    fn update_skeleton_inner(
        ...
        next.head.ori = Quaternion::rotation_z(look.x * 0.6) * Quaternion::rotation_x(look.y * 0.6 + breathing);
        ...
        next.upper_torso.ori = Quaternion::rotation_z(0.0) * Quaternion::rotation_x(- breathing);
        ...
        next.lower_torso.ori = Quaternion::rotation_z(0.0) * Quaternion::rotation_x(breathing);
        ...
        next.jaw.ori = Quaternion::rotation_x(-0.1 + breathing * 2.0);
        ...
        next.shoulder_l.ori = Quaternion::rotation_z(0.0) * Quaternion::rotation_x(breathing);
        ...
        next.shoulder_r.ori = Quaternion::rotation_z(0.0) * Quaternion::rotation_x(breathing);
