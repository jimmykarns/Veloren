...
impl Animation for RunAnimation {
    ...
    fn update_skeleton_inner(
        ...
        if skeleton_attr.beast {
            next.head.offset = Vec3::new(0.0, skeleton_attr.head.0 + skeleton_attr.beast_head.0, skeleton_attr.head.1 + skeleton_attr.beast_head.1) * 1.02;
            next.head.ori = Quaternion::rotation_z(shortalt * -0.18) * Quaternion::rotation_x(skeleton_attr.beast_ori - short * 0.05);
            ...
            next.upper_torso.ori = Quaternion::rotation_x(-skeleton_attr.beast_ori) * Quaternion::rotation_z(shortalt * 0.18);
            ...
            next.shoulder_l.ori = Quaternion::rotation_x(footrotl2 * -0.36 + skeleton_attr.beast_ori)
            ...
            next.shoulder_r.ori = Quaternion::rotation_x(footrotr2 * -0.36 + skeleton_attr.beast_ori)
                * Quaternion::rotation_y(-0.1)
            ...
            next.hand_l.ori = Quaternion::rotation_x(0.15 + (handhorir2 * -1.2).max(-0.3) + skeleton_attr.beast_ori)
            ...
            next.hand_r.ori = Quaternion::rotation_x(0.15 + (handhoril2 * -1.2).max(-0.3) + skeleton_attr.beast_ori)
