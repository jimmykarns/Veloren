        ...
        *rate = 1.0;
        if speed < 25.0 {
            ...
            next.chest.offset = Vec3::new(
                ...
                -5.0 + skeleton_attr.chest.1 + 1.0,
            );
            next.chest.ori = Quaternion::rotation_z(tilt * -2.0) * Quaternion::rotation_x(-0.5);
            next.chest.scale = Vec3::one() * 1.01;

            next.belt.offset =
                Vec3::new(0.0, skeleton_attr.belt.0 + 1.0, 1.5 + skeleton_attr.belt.1);
            next.belt.ori = Quaternion::rotation_z(tilt * 2.0) * Quaternion::rotation_x(0.3);
            next.belt.scale = Vec3::one();
            ...
            next.shorts.offset = Vec3::new(
                0.0,
                skeleton_attr.shorts.0 + 2.5,
                3.0 + skeleton_attr.shorts.1,
            );
            next.shorts.ori = Quaternion::rotation_z(tilt * 3.0) * Quaternion::rotation_x(0.6);
            next.shorts.scale = Vec3::one();
            ...
            next.l_hand.ori = Quaternion::rotation_x(0.8 + slow * -0.1);
            next.l_hand.scale = Vec3::one();
            ...
            next.r_hand.ori = Quaternion::rotation_x(0.8 + slow * 0.1);
            next.r_hand.scale = Vec3::one();
        ...
        next.torso.scale = Vec3::one() / 11.0 * skeleton_attr.scaler;
            ...
            next.lantern.ori =
                Quaternion::rotation_x(slow * 0.3) * Quaternion::rotation_y(0.6 + slow * 0.3);
            next.lantern.scale = Vec3::one() * 0.65;
