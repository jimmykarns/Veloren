...
impl Animation for IdleAnimation {
    ...
    fn update_skeleton_inner(
        ...
        next.head.ori =
            Quaternion::rotation_z(0.0) * Quaternion::rotation_x(tilt);
        ...
        next.jaw.ori = Quaternion::rotation_x(tilt);
        next.jaw.scale = Vec3::one();

        next.tongue.offset = Vec3::new(
            0.0,
            skeleton_attr.tongue.0 + (((((anim_time as f32 * 4.0).cos()).abs()) * 14.0).min(8.0)),
            skeleton_attr.tongue.1,
        );
        next.tongue.ori = Quaternion::rotation_x(((anim_time as f32 * 40.0).cos()) * (anim_time as f32  * 4.0).cos());
        ...
        next.body0.ori = Quaternion::rotation_z(tilt);
        ...
        next.body1.ori = Quaternion::rotation_z(tilt);
        ...
        next.body2.ori = Quaternion::rotation_z(tilt);
        ...
        next.body3.ori = Quaternion::rotation_z(tilt);
        ...
        next.body4.ori = Quaternion::rotation_z(tilt);
        ...
        next.body5.ori = Quaternion::rotation_z(tilt);
        ...
        next.body6.ori = Quaternion::rotation_z(tilt);
        ...
        next.body7.ori = Quaternion::rotation_z(tilt);
        ...
        next.body8.ori = Quaternion::rotation_z(tilt);
        ...
        next.body9.ori = Quaternion::rotation_z(tilt);
