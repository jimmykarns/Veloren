...
use crate::{
    ...
    ui::{fonts::Fonts, slot, Graphic, Ingameable, ScaleMode, Ui},
...
impl Hud {
    ...
    fn update_layout(
        ...
        // Social Window
        if self.show.social {
            for event in Social::new(&self.show, client, &self.imgs, &self.fonts, &self.i18n)
        ...
        if self.show.free_look {
            Text::new(&self.i18n.get("hud.free_look_indicator"))
                .color(TEXT_BG)
