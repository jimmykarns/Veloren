            ...
            Outcome::Explosion {
                ...
                for _ in 0..150 {
                    self.particles.push(Particle::new(
                        Duration::from_millis(if let Some(_) = reagent { 1000 } else { 250 }),
                        time,
                        match reagent {
    ...
    fn maintain_body_particles(&mut self, scene_data: &SceneData) {
            ...
            .enumerate()
        {
            match body {
                ...
                | Body::Object(object::Body::FireworkBlue)
                | Body::Object(object::Body::FireworkGreen)
                | Body::Object(object::Body::FireworkPurple)
                | Body::Object(object::Body::FireworkRed)
                | Body::Object(object::Body::FireworkYellow) => {
