...
pub fn criterion_benchmark(c: &mut Criterion) {
    // Use benchmark group to customize sample size
    ...
    group.bench_function("copying 1,1 into flat array", move |b| {
        b.iter(|| {
    ...
    for x in 1..GEN_SIZE - 1 {
        for y in 1..GEN_SIZE - 1 {
            ...
            group.bench_function(&format!("Terrain mesh {}, {}", x, y), move |b| {
